        ...
        <scroller class="progress" scroll-direction="horizontal">
          <div :style="getProgressWidth">
            ...
            <div class="iconLineBox">
                ...
                <!-- 最后一步显示交易结果的流程图，审核拒绝的不在此显示（）这边都是待审核 -->
                <div style="flex-direction:row;">
                    <!-- 流程图的线条 三种（蓝：成功或预受理，灰色：待审核，红色：失败） -->
                    <image class="iconLine" :src="greyIconLineSrc"></image><!-- 待审核 -->
                    <!-- 流程图的圆圈 -->
                    <div class="stepIconBox">
                      <!-- 流程图的圆圈 三种（蓝：成功或预受理，灰色：待审核，红色：失败） -->
                      <image :src="grayAgentIconFirst" class="stepIcon"></image>
            ...
            <div style="flex-direction: row;">
              ...
              <div class="everyStepBox">
                  <text class="checkStatusText greyFont">待审核</text><!--审核结果-->
              </div>
            </div>
          </div>
        </scroller>

    ...
    <div class="title-box">
      <div v-if="centerElement.exist">
        <div class="title-text-box" v-if="centerElement.title.exist">
          <text class="title">{{title}}{{this.$store.state.selectPageNumber}}项</text>
        </div>
      </div>
    </div>
    <div class="title-right">
      <div v-if="rightElement.exist">
         <div class="imgDiv" v-if="rightElement.login.exist"  @click="add">
          <text class="addaccount">{{edit}}</text>
        </div>
      </div>
    </div>
  </div>

  ...
  <div class="header" >
    <div class="title-left">
      <div v-if="leftElement.exist">
        <div class="backDiv" v-if="leftElement.back.exist" @click="goBack">
          <image class="backImg" :src="leftElement.back.src"></image>
        </div>
      </div>
    </div>
    <div class="title-box">
    ...
    <div class="title-right">
      <div v-if="rightElement.exist">
         <div class="imgDiv" v-if="rightElement.login.exist" @click="goto()">
          <image class="qrImg" :src="rightElement.login.src"></image>
        </div>
      </div>
    </div>
  </div>
...
export default {
    ...
    return {
      ...
      rightElement: {
        exist: true,
         login: {
          exist: true,
          src:  this.$store.state.imgBaseUrl + "/66.png",
          url: ""
        }
      },
      bgcolor: "#ffffff",
  ...
  methods: {
    goto(){
     this.$store.state.promptShow=true;
    }
  }
};
</script>
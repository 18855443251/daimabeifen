    ...
    <div class="maintext" :style="getPosiScrollerTop">
        ...
        <div class="searchTopBox">
            <div class="searchInputBox">
                ...
                <input type="text" class="searchInput" v-model="searchInput" placeholder="请输入户名/账号/用途搜索" @blur="searchRecord" />
            </div>
        </div>
                ...
                <div v-if="filterZiDuan=='0'">
                    <div style="width:750px;height:558px;background-color:#fff;">
                        <scroller style="width:750px;height:470px;">
                          <div v-if="!$store.state.accountProtect">
                          ...
                          <div v-else>
                              <text class="AcNoColSty" :class="[AcNoindex==index ? 'activeAcNo' : '']" v-for="(item,index) in AcNoList" :key="index" @click="chooseAcNo(index)">{{item.AcNo|AccountNoFormat(6,-4)}}</text>
                          </div>
                        </scroller>
                ...
                <div v-else-if="filterZiDuan=='1'">
                    <div style="width:750px;height:558px;">
                        <div style="margin-left:30px;flex-direction:row;margin-top:60px;">
                            ...
                            <text class="selectedDate" style="margin-left:20px;">({{BeginDate}}-{{EndDate}})</text>
                        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        filterZiDuan:'N',//保存点击的哪个删选条件,不默认选中
        PayerAcNo:'',//选择的账户
    ...
    methods: {
      ...
      //跳转到记录详情
      jumpdetail(item){
        this.$store.state.RecordListInFo=item;
        this.jump({
           name:'RecordDetail',
        })
      },
